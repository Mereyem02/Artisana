...
#[UniqueEntity(
    fields: ['email'],
    message: 'Cet email est déjà utilisé par une autre coopérative.'
)]
#[UniqueEntity(
    fields: ['telephone'],
    message: 'Ce numéro de téléphone est déjà utilisé par une autre coopérative.'
)]
#[UniqueEntity(
    fields: ['siteWeb'],
    message: 'Ce site web est déjà utilisé par une autre coopérative.',
    ignoreNull: true
)]
class Cooperative
{
