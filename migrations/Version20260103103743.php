 ...
 */
final class Version20260103103743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cooperative CHANGE logo logo VARCHAR(255) DEFAULT NULL, CHANGE contact contact VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cooperative CHANGE logo logo VARCHAR(255) NOT NULL, CHANGE contact contact VARCHAR(255) NOT NULL');
